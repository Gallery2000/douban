    ...
    getGroup ({ commit }) {
      let dataA = [
        ...
        },
        {
          ...
          id: 1234,
          images: {
            small: 'http://img3.imgtn.bdimg.com/it/u=1432990296,2457424959&fm=27&gp=0.jpg'
          },
          group_member: '4373',
          group_topic: {
      ...
      let dataB = [
        ...
        },
        {
          ...
          id: 1234,
          images: {
            small: 'http://img3.imgtn.bdimg.com/it/u=3348943606,3748877901&fm=27&gp=0.jpg'
          },
          group_member: '96960',
          group_topic: {
            title: '北京 征个女生',
      ...
      let dataC = [
        {
          ...
          id: 1234,
          images: {
            small: 'http://img2.imgtn.bdimg.com/it/u=1816452872,2477360268&fm=27&gp=0.jpg'
          },
          group_member: '431999',
          group_topic: {
